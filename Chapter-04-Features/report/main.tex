...
\begin{figure}[htbp]
  ...
  \subfigure[中值滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/median_blur_0618.png}
}
  \subfigure[中值滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/median_blur_0854.png}
}
  \subfigure[中值滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/median_blur_1066.png}
}
  \subfigure[均值滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/average_blur_0618.png}
}
  \subfigure[均值滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/average_blur_0854.png}
}
  \subfigure[均值滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/average_blur_1066.png}
}
  \subfigure[高斯滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/gaussian_blur_0618.png}
}
\subfigure[高斯滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/gaussian_blur_0854.png}
}
\subfigure[高斯滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/gaussian_blur_1066.png}
}
  \subfigure[双边滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/bilateral_filter_0618.png}
}
\subfigure[双边滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/bilateral_filter_0854.png}
}
\subfigure[双边滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/bilateral_filter_0854.png}
}
...
\subfigure[均值迁移滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/mean_shift_filter_0854.png}
}
\subfigure[均值迁移滤波]{
	\includegraphics[width=0.3\linewidth]{../output/1_image_processing/mean_shift_filter_1066.png}
}
\caption{原始图像滤波结果}
...
\begin{figure}[!h]
	\centering
	\subfigure{
	\includegraphics[width=.2\linewidth, frame]{../output/0618classifiers/mean_shift_filter/original_feature/feature_1_svm.png}	
}
	\subfigure{
	\includegraphics[width=.2\linewidth, frame]{../output/0618classifiers/mean_shift_filter/original_feature/feature_1_random_forest.png}	
}
	\subfigure{
	\includegraphics[width=.2\linewidth, frame]{../output/0618classifiers/mean_shift_filter/original_feature/feature_1_knn.png}	
}

\subfigure{
	\includegraphics[width=.2\linewidth, frame]{../output/0854classifiers/mean_shift_filter/original_feature/feature_1_svm.png}	
}
\subfigure{
\includegraphics[width=.2\linewidth, frame]{../output/0854classifiers/mean_shift_filter/original_feature/feature_1_random_forest.png}	
}
\subfigure{
\includegraphics[width=.2\linewidth, frame]{../output/0854classifiers/mean_shift_filter/original_feature/feature_1_knn.png}	
}

\subfigure{
	\includegraphics[width=.2\linewidth, frame]{../output/1066classifiers/mean_shift_filter/original_feature/feature_1_svm.png}	
}
\subfigure{
\includegraphics[width=.2\linewidth, frame]{../output/1066classifiers/mean_shift_filter/original_feature/feature_1_random_forest.png}	
}
\subfigure{
\includegraphics[width=.2\linewidth, frame]{../output/1066classifiers/mean_shift_filter/original_feature/feature_1_knn.png}	
}
...
\begin{figure}[!h]
	\centering
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/svm/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/svm/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/svm/opening_closing.png}	
	}
	\subfigure[]{
	\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/svm/closing_opening.png}	
}

		\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/random_forest/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/random_forest/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/random_forest/opening_closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/random_forest/closing_opening.png}	
	}

	\subfigure[]{
	\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/knn/opening.png}	
}
\subfigure[]{
	\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/knn/closing.png}	
}
\subfigure[]{
	\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/knn/opening_closing.png}	
}
\subfigure[]{
	\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0618/knn/closing_opening.png}	
}
	
	\caption{0618.png图像经过形态学方法优化的结果}
	\label{fig:0618opearation}
\end{figure}

\begin{figure}[!h]
	\centering
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/svm/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/svm/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/svm/opening_closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/svm/closing_opening.png}	
	}
	
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/random_forest/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/random_forest/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/random_forest/opening_closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/random_forest/closing_opening.png}	
	}
	
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/knn/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/knn/closing.png}	
	}
	\subfigure[\label{fig:0854operation:k}]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/knn/opening_closing.png}	
		
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/0854/knn/closing_opening.png}	
	}
	
	\caption{0854.png图像经过形态学方法优化的结果}
	\label{fig:0854opearation}
\end{figure}
...
\begin{figure}[!h]
	\centering
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/svm/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/svm/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/svm/opening_closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/svm/closing_opening.png}	
	}
	
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/random_forest/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/random_forest/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/random_forest/opening_closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/random_forest/closing_opening.png}	
	}
	
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/knn/opening.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/knn/closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/knn/opening_closing.png}	
	}
	\subfigure[]{
		\includegraphics[width=.2\linewidth, frame]{../output/4_post_processing/1066/knn/closing_opening.png}	
	}
